...
<div class="modal fade" id="modalTambahPersonil" tabindex="-1" aria-labelledby="modalTambahPersonilLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content border-0 shadow-lg rounded-4 overflow-hidden">
            <form action="{{ route('sdm.store') }}" method="POST" enctype="multipart/form-data" class="d-flex flex-column flex-fill" style="min-height: 0;">
                @csrf
                ...
                <div class="modal-body p-4 bg-white flex-grow-1" style="min-height: 0; overflow-y: auto;">
                    <div class="mb-3">
                        ...
                        <input type="text" name="nama" class="form-control form-control-sm py-2" value="{{ old('nama') }}" placeholder="mis. Nesya " required>
                    </div>
                ...
                <div class="modal-footer bg-light px-4 py-3 border-top flex-shrink-0 d-flex justify-content-end gap-2">
