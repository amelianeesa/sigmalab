    ...
    <div class="container-fluid px-4">
        <div class="d-flex flex-wrap gap-3 mb-2 mt-1">
            @if(
                ...
                <a href="{{ route('hak-akses.index') }}" class="btn btn-warning rounded-pill px-4 shadow-sm text-dark fw-bold"
            ...
            @if(
                ...
                <a href="{{ route('kelola-user.index') }}" class="btn rounded-pill px-4 shadow-sm text-white fw-bold"
                    style="background-color: #0d3b66; transition: transform 0.2s;"
                ...
                <div class="row g-2 align-items-center">
                    ...
                    <div class="col-md-3 col-sm-6">
                        @if(
                            ...
                            <button type="button" class="btn btn-primary btn-sm w-100 text-truncate"
                                data-bs-toggle="modal" data-bs-target="#modalTambahPersonil">
                        ...
                        <tbody id="personilTableBody">
                            @forelse($personil as $index => $row)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <code class="fw-bold">{{ $row->no_induk }}</code>
                                    </td>
                                    ...
                                    <td class="text-nowrap">
                                        @if(
                                            ...
                                            <form action="{{ route('sdm.activate', $row->personil_id) }}"
                                                method="POST"
                                                class="d-inline"
                                                onsubmit="return confirm('Aktifkan kembali {{ $row->nama }}?')">
                                                @csrf
                                                @method('PATCH')
                                        ...
                                        @if(
                                            ...
                                            <div class="dropdown d-inline-block">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end shadow-sm">
                                                    ...
                                                    @else
                                                        <li>
                                                            <form action="{{ route('sdm.destroy', $row->personil_id) }}"
                                                                method="POST"
            ...
            <div class="modal-content">
                <form action="{{ route('sdm.store') }}"
                    ...
                    <div class="modal-header bg-dark text-white">
                        <h5 class="modal-title fs-6" id="modalTambahPersonilLabel">
                            <i class="fas fa-user-plus me-2"></i>
                            ...
                            <div class="card-body row g-3">
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="form-text text-muted"
                                        style="font-size: 0.75rem;">
                                        Format: JPG, PNG, PDF
                                        (Maks. 2MB). Isi sesuai template, lalu unggah di sini.
                                    </div>
                                </div>
                            </div>
                        </div>
