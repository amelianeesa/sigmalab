...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3 mb-0 text-gray-800">{{ ($jenisGrafik ?? 'in_house') == 'crm' ? 'Sertifikat Pabrik (CRM)' : 'Inhouse Control' }}: Volatile Matter (VM)</h1>
    </div>
                    ...
                    <table class="table table-bordered table-hover mb-0 text-center align-middle" style="font-size: 0.8rem;">
                        <thead class="table-light sticky-top">
                            <tr>
                                ...
                                <th class="bg-primary text-white" title="Massa cawan + Residu">M3</th>
                                <th class="bg-secondary text-white" title="M2 - M3">M2-M3</th>
                                ...
                                <th rowspan="2" class="align-middle bg-success text-white">Average %db</th>
                            </tr>
                            <tr>
                        ...
                        <tbody>
                            ...
                            @empty
                                <tr>
                                    <td colspan="16" class="text-center py-4">Belum ada data pengujian Volatile Matter.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
        ...
        @if(isset($chartData) && count($chartData['labels']) > 0 && $selectedParameter->nama_parameter !== 'Bias Test VM (Pt)')
                ...
                <div class="col-xl-9 col-md-12 mb-4">
                    <div class="card shadow h-100">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Tabel Limit Control Chart In-house VM</h6>
                        </div>
                        <div class="card-body p-0">
