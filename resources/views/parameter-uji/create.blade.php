...
<div class="container-fluid px-4">
    <h1 class="mt-4">Tambah Parameter Uji</h1>
                    ...
                    <div class="card-body py-2">
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="number" step="0.0001" name="lcl" class="form-control form-control-sm" value="{{ old('lcl') }}">
                            </div>
                            <div class="col">
                                <label class="form-label" style="font-size: 0.8rem;">UWL Bawah (Warning)</label>
                                <input type="number" step="0.0001" name="uwl_bawah" class="form-control form-control-sm" value="{{ old('uwl_bawah') }}">
                            </div>
                            <div class="col">
                                <label class="form-label" style="font-size: 0.8rem;">Mean (Rata-rata)</label>
                                <input type="number" step="0.0001" name="mean" class="form-control form-control-sm" value="{{ old('mean') }}">
                            </div>
                            <div class="col">
                                <label class="form-label" style="font-size: 0.8rem;">UWL Atas (Warning)</label>
                                <input type="number" step="0.0001" name="uwl_atas" class="form-control form-control-sm" value="{{ old('uwl_atas') }}">
                            </div>
                            <div class="col">
                                <label class="form-label" style="font-size: 0.8rem;">UCL (Upper Control)</label>
                                <input type="number" step="0.0001" name="ucl" class="form-control form-control-sm" value="{{ old('ucl') }}">
                            </div>
                        </div>
                    </div>
                </div>
