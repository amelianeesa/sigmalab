    ...
    <form action="{{ route('qc-uji-banding.store-investigasi', [$program->id, $parameter->id]) }}" method="POST">
        ...
        <div class="card shadow-sm border-danger mb-4">
            <div class="card-header bg-danger text-white">
                <h5 class="mb-0 fw-bold"><i class="fas fa-search me-2"></i>Bagian 1: Analisis Akar Masalah (Root Cause)</h5>
            </div>
        ...
        <div class="card shadow-sm border-primary mb-4">
            <div class="card-header bg-primary text-white">
                <h5 class="mb-0 fw-bold"><i class="fas fa-tools me-2"></i>Bagian 2: Tindakan Perbaikan (Corrective Action)</h5>
            </div>
            <div class="card-body p-4">
        ...
        <div class="card shadow-sm border-success mb-4">
            <div class="card-header bg-success text-white">
                <h5 class="mb-0 fw-bold"><i class="fas fa-shield-alt me-2"></i>Bagian 3: Tindakan Pencegahan (Preventive Action)</h5>
            </div>
            <div class="card-body p-4">
