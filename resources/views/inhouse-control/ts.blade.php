                        ...
                        <table class="table table-bordered table-sm text-center" style="font-size: 0.85rem;">
                            <thead class="table-light">
                                <tr>
                                    ...
                                    <th rowspan="2" class="align-middle">Abs. Diff<br><small>(|TS1 - TS2|)</small></th>
                                    <th rowspan="2" class="align-middle">Avg %<br>(adb)</th>
                                    <th rowspan="2" class="align-middle">IM %</th>
                                    <th rowspan="2" class="align-middle">Avg %<br>(db)</th>
                            ...
                            <tbody>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="12">Belum ada data pengujian TS.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        new Chart(ctx, {
            ...
            options: {
                ...
                scales: {
                    y: {
                        title: { display: true, text: 'Persentase (%db)' },
