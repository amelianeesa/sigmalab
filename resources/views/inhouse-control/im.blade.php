...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3 mb-0 text-gray-800">Inhouse Control: Inherent Moisture (IM)</h1>
    </div>

    @include('inhouse-control.partials.filter-form')
    ...
    @else
        ...
        @if(isset($chartData) && count($chartData['labels']) > 0)
            ...
            <div class="row">
                @include('inhouse-control.partials.stats-cards')
                @include('inhouse-control.partials.limit-table')
            </div>
            
            @include('inhouse-control.partials.westgard-table')
            @include('inhouse-control.partials.chart-scripts')
