...
<div class="container-fluid dashboard-container">
    <div class="d-flex justify-content-between align-items-center mb-2 mt-1 flex-wrap gap-2">
        <div>
            <h4 class="fw-bold text-dark mb-0" style="font-size: 1.05rem;">Upload Dokumen</h4>
            <p class="text-muted small mb-0" style="font-size: 0.72rem;">Tambah dokumen prosedur, formulir, atau instruksi kerja.</p>
        </div>
            ...
            <form action="{{ route('library.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row g-2">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="nomor_dokumen" value="{{ old('nomor_dokumen') }}" class="form-control form-control-sm">
                    </div>

                    <div class="col-md-6">
                        <label class="form-label">Penerbit Dokumen</label>
                        <input type="text" name="penerbit_dokumen" value="{{ old('penerbit_dokumen') }}" class="form-control form-control-sm" placeholder="Contoh: Sub Bagian QSHE">
                    </div>

                    <div class="col-md-6">
                        <label class="form-label">Tanggal Berlaku</label>
                        <input type="text" name="tanggal_berlaku" id="tglBerlaku" value="{{ old('tanggal_berlaku', now()->toDateString()) }}" class="form-control form-control-sm flatpickr-date" placeholder="dd/mm/yyyy" autocomplete="off" required>
                    </div>

                    <div class="col-12">
                        <label class="form-label">Deskripsi</label>
                        <textarea name="deskripsi" rows="3" class="form-control form-control-sm" style="font-size: 0.72rem !important;">{{ old('deskripsi') }}</textarea>
                    </div>
                    ...
                    <div class="col-12">
                        ...
                        <small class="text-muted" style="font-size: 0.68rem;">Maksimal 20 MB. Format: PDF, Office, JPG, atau PNG.</small>
                    </div>
                </div>
