            ...
            <form action="{{ route('library.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="penerbit_dokumen" value="{{ old('penerbit_dokumen') }}" class="form-control" placeholder="Contoh: Sub Bagian QSHE">
                    </div>

                    <div class="col-md-6">
                        <label class="form-label">Tanggal Berlaku</label>
                        <input type="date" name="tanggal_berlaku" value="{{ old('tanggal_berlaku', now()->toDateString()) }}" class="form-control" required>
                    </div>
