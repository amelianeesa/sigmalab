...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
            ...
            <form action="{{ route('tindak-lanjut.index') }}" method="GET" class="form-inline live-search-form" data-target="#table-container">
                <select name="status_tindak_lanjut" class="form-select form-select-sm">
                    ...
                    <option value="selesai" {{ (isset($filterStatus) && $filterStatus == 'selesai') ? 'selected' : '' }}>Selesai</option>
                </select>
            </form>
        </div>
                ...
                <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('tindak-lanjut.show', $item->riwayat_tindak_lanjut_id) }}" class="btn btn-info btn-sm" title="Detail">
