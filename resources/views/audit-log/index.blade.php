...
<div class="container-fluid px-4 py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <!-- <div>
            ...
            <p class="text-muted mb-0 mt-2">Rekam jejak aktivitas pengguna dan perubahan data dalam sistem.</p>
            <ol class="breadcrumb mb-0 mt-2 text-muted">
    ...
    <div class="card shadow-sm border-0 mb-4">
        <div class="card-body">
            <form action="{{ route('audit-log.index') }}" method="GET" class="row g-3 align-items-end" id="filter-form">
                <div class="col-md-4">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="subject_type" class="form-control form-control-sm" placeholder="Ketik nama entitas (Contoh: Barang, Kegiatan)..." value="{{ request('subject_type') }}">
                </div>
                <div class="col-md-2">
                    <a href="{{ route('audit-log.index') }}" class="btn btn-sm btn-outline-secondary w-100">Reset Filter</a>
                </div>
            </form>
        </div>
    </div>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        // Auto submit when typing (with 500ms debounce)
        let timeout = null;
