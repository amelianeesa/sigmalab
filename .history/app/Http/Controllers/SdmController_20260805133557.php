    ...
    public function showCv($id)
{
    ...
    // Pastikan path filenya diarahkan dengan benar menggunakan asset storage
    $cvUrl = $personil->file_cv ? asset('storage/uploads/cv/' . $personil->file_cv) : null;

    return view('sdm.cv_view', compact('personil', 'cvUrl'));
}
}