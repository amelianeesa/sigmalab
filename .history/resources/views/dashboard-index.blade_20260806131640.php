...
<div class="container-fluid px-4 py-4">
    ...
    <!-- Layout 2 Kolom: Kiri Grid Modul, Kanan Aktivitas Terbaru -->
    <div class="row g-4">
        
        <!-- KOLOM KIRI: GRID MODUL (Lebar 8) -->
        <div class="col-12 col-lg-8">
            <div class="row g-3">

                <!-- SDM (Ditempatkan sejajar di grid agar rapi) -->
        ...
        <!-- KOLOM KANAN: AKTIVITAS TERBARU (Lebar 4) -->
