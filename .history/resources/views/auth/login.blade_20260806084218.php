            ...
            <div class="col-md-4">
                <div class="card auth-card shadow-sm">
                    ...
                    <div class="card-body auth-body">
                        <p class="auth-subtitle text-center">Masukkan kredensial yang sudah terdaftar.</p>
                        ...
                        <div class="text-center mt-3">
                            <small class="text-muted">Belum punya akun? <a href="{{ route('register') }}" class="auth-link">Daftar</a></small>
                        </div>
