...
<div class="container-fluid px-4 py-4">
    ...
    <!-- Bagian Atas: Profil Personil & Tombol Tambah Personil -->
    ...
    <!-- Bagian Bawah: Daftar Semua Personil Lab & Kalibrasi -->
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content border-0 shadow-lg rounded-4 overflow-hidden" style="max-height: 90vh;">
            ...
            <form action="{{ route('sdm.store') }}" method="POST" enctype="multipart/form-data" class="d-flex flex-column h-100">
                ...
                <!-- Body Modal (Bisa di-scroll jika panjang) -->
                <div class="modal-body p-4 bg-white" style="overflow-y: auto; flex-grow: 1;">
                ...
                <!-- Footer Modal (Tombol Batal & Simpan Menempel di Bawah) -->
                <div class="modal-footer bg-light px-4 py-3 border-top">
                    ...
                    <button type="submit" class="btn btn-dark px-4 fw-semibold shadow-sm" style="background-color: #0b1f36;">Simpan</button>
                </div>
            </form>
        </div>
    </div>
