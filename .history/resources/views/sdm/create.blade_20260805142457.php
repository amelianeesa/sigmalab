        ...
        <div class="modal-content border-0 shadow-lg rounded-4 overflow-hidden">
            ...
            <form action="{{ route('sdm.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body p-4 bg-white" style="max-height: 70vh; overflow-y: auto;">
                    ...
                    <div class="mb-3">
                        <label class="form-label text-secondary small fw-semibold">Nama Lengkap & Gelar</label>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            <label class="form-label text-secondary small fw-semibold">Tgl Berakhir</label>
