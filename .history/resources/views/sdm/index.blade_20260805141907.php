                    ...
                    <div>
                        ...
                        @if($selectedPersonil->file_cv)
                            <a href="{{ route('sdm.cv', $selectedPersonil->personil_id) }}" target="_blank" class="text-decoration-none small text-primary fw-semibold">
                                <i class="bi bi-file-earmark-pdf me-1"></i> CV: Buka Dokumen
                            </a>
                        @else
        ...
        <div class="modal-content border-0 shadow-lg rounded-4 overflow-hidden">
            ...
            <form action="{{ route('sdm.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body p-4 bg-white">
                    ...
                    <div class="mb-3">
                        <label class="form-label text-secondary small fw-semibold">Upload Dokumen CV <span class="text-muted fw-normal">(PDF / Foto, Maks. 2MB)</span></label>
                        <input type="file" name="file_cv" class="form-control" accept=".pdf, .jpg, .jpeg, .png">
                    </div>
