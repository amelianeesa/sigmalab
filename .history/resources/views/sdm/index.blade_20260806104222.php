...
<style>
    ...
    .sdm-page .personil-table thead th { background: #f7f9fc; border-bottom: 1px solid #dfe6ee; color: #64748b; font-size: .68rem; font-weight: 700; letter-spacing: .06em; padding: 11px 14px; text-transform: uppercase; white-space: nowrap; text-align: center; }
    .sdm-page .personil-table tbody td { border-color: #edf1f5; padding: 11px 14px; vertical-align: middle; text-align: center; }
