...
<body>
    ...
    <div id="sidebar" class="d-flex flex-column">
        ...
        <ul class="nav flex-column mt-3">
            <li class="nav-item">
                <a href="{{ route('dashboard') }}" class="nav-link active"><i class="bi bi-speedometer2 me-2"></i> Dashboard</a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a href="#" class="nav-link"><i class="bi bi-people me-2"></i> SDM & Kompetensi</a>
            </li>
            <li class="nav-item">
    ...
    <div class="top-navbar shadow-sm">
        <div>
            ...
            <small class="text-muted">Ringkasan operasional laboratorium hari ini</small>
        </div>
        <div class="dropdown">
