...
<body>
    ...
    <div class="top-navbar shadow-sm">
        ...
        <div class="d-flex align-items-center gap-2">
            <div class="btn btn-light border d-flex align-items-center gap-1" style="color:#0f3b68; background: rgba(255,255,255,.95);">
                <i class="bi bi-person-circle"></i> {{ Auth::user()->name ?? Auth::user()->username ?? 'Pengguna' }}
            </div>
            <form action="{{ route('logout') }}" method="POST" class="m-0">
                @csrf
                <button type="submit" class="btn btn-outline-light border text-white">
