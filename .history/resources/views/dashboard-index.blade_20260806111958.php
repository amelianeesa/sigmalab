    ...
    <div class="min-h-screen p-6 lg:p-8 max-w-7xl mx-auto">
        ...
        <div class="mb-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-4">
                ...
                <a href="#sdm" class="bg-white p-5 rounded-xl shadow-sm border border-gray-200 hover:border-indigo-500 hover:shadow-md transition-all group flex flex-col justify-between">
                    <div>
                        <div class="text-2xl mb-2">👤</div>
                        <h3 class="font-bold text-gray-800 group-hover:text-indigo-600">SDM</h3>
                        <p class="text-xs text-gray-400 mt-1">Kelola personil, kompetensi, & pelatihan</p>
                    </div>
                    <span class="text-xs font-semibold text-indigo-600 mt-4 flex items-center gap-1">Buka Modul &rarr;</span>
                </a>
