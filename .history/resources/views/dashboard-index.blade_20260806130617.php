...
@section('content')
<div class="container-fluid px-4 py-3 sdm-theme">
            ...
            <div class="row g-3">
                    ...
                    <a href="#" class="text-decoration-none">
                        <div class="card h-100 shadow-sm rounded-3 border border-light-subtle transition-card">
                            <div class="card-body p-3">
                                <div class="mb-2 module-icon text-primary">⛭</div>
                ...
                <div class="col-12">
                    <a href="{{ route('sdm.index') }}" class="text-decoration-none">
                        <div class="card h-100 shadow-sm rounded-3 border-2 transition-card sdm-highlight" style="background-color: var(--sdm-50); border-color: var(--sdm-300);">
                            <div class="card-body p-3 d-flex align-items-center justify-content-between">
                                <div class="d-flex align-items-center gap-3">
                                    <div class="module-icon sdm-icon fs-2">👤</div>
                                    <div>
                                        <h6 class="fw-bold mb-1 sdm-text">Modul SDM (Sumber Daya Manusia)</h6>
                                        <p class="text-muted small mb-0" style="font-size: 12px;">Kelola personil, kompetensi, sertifikasi, dan hak akses.</p>
                                    </div>
                                </div>
                                <span class="text-muted small fw-bold">&rarr;</span>
                            </div>
                        </div>
                    </a>
                </div>
        ...
        <div class="col-12 col-lg-4">
            ...
            <div class="card shadow-sm rounded-3 border border-light-subtle mb-4">
                <div class="card-body p-3">
                    ...
                    <!-- List Aktivitas (Contoh data / bisa di-loop dari database audit/aktivitas) -->
                    <div class="timeline-container border-start ps-3 ms-2 py-1" style="border-color: #dee2e6 !important;">
                        
                        <!-- Jika ada aktivitas (Contoh item) -->
                        ...
                        <!-- Jika kosong (bisa dikondisikan pakai @if kosong) -->
                        <!-- 
            ...
            <!-- Kartu Tambahan: Informasi Cepat / Status Laboratorium -->
            <div class="card shadow-sm rounded-3 border border-light-subtle bg-light-subtle">
                <div class="card-body p-3">
...
<!-- CSS tambahan untuk efek transisi dan timeline -->
<style>
    .transition-card {
