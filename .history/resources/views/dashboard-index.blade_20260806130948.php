    ...
    <div class="row g-3 justify-content-center">
        ...
        <div class="col-12 col-sm-6 col-md-6 col-lg-4">
            <a href="{{ route('sdm.index') }}" class="text-decoration-none">
                <div class="card h-100 shadow-sm rounded-3 border-2 transition-card sdm-highlight" style="background-color: #eef0f1;">
                    <div class="card-body p-3">
...
<style>
    ...
    .sdm-icon { font-size: 34px; color: var(--sdm-600); }
</style>
@endsection